...
const UUID: string = Deno.env.get("UUID") || "1a265f0e-9306-45ce-9b2e-85f88fd7dbc9";
const SUB_PATH: string = Deno.env.get("SUB_PATH") || "sub";  //获取订阅路径
const XPATH: string = Deno.env.get("XPATH") || "xhttp";      // 节点路径
const DOMAIN: string = Deno.env.get("DOMAIN") || "darrenkstan-ivxong-89.deno.dev";         // deno分配的域名必填，不带https://前缀，例如：xxxx.deno.dev      
